...
/**
 * This class stands for ArrayOfStockPrice ArrayType
 * @subpackage Arrays
 */
class ArrayOfStockPrice extends AbstractStructArrayBase
{
    /**
     * The StockPrice
    ...
    {
        return isset($this->StockPrice) ? $this->StockPrice : null;
    }
    /**
     * This method is responsible for validating the values passed to the setStockPrice method
     * This method is willingly generated in order to preserve the one-line inline validation within the setStockPrice method
     * @param array $values
     * @return string A non-empty message if the values does not match the validation rules
     */
    public static function validateStockPriceForArrayConstraintsFromSetStockPrice(array $values = array())
    {
        $message = '';
        $invalidValues = [];
    ...
    public function setStockPrice(array $stockPrice = array())
    {
        ...
        if ('' !== ($stockPriceArrayErrorMessage = self::validateStockPriceForArrayConstraintsFromSetStockPrice($stockPrice))) {
            throw new \InvalidArgumentException($stockPriceArrayErrorMessage, __LINE__);
        }
        if (is_null($stockPrice) || (is_array($stockPrice) && empty($stockPrice))) {
            unset($this->StockPrice);
        } else {
